...
filter the compiler source registry. The package concept is named xspkg; its archive suffix is `.xspkg.tar.zst`, never
`.xspkg` alone. `source.exclude`, `module.exclude`, and `test.exclude` each default to `*/**`; an
